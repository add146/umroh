...
const adminCreateUserSchema = z.object({
    ...
    role: z.enum(['pusat', 'cabang', 'mitra', 'agen', 'reseller', 'teknisi', 'pic_produk', 'pic_logistik', 'pic_jamaah', 'finance']),
...
const adminUpdateUserSchema = z.object({
    ...
    role: z.enum(['pusat', 'cabang', 'mitra', 'agen', 'reseller', 'teknisi', 'pic_produk', 'pic_logistik', 'pic_jamaah', 'finance']).optional(),
    nik: z.string().optional().nullable(),
    affiliateCode: z.string().optional().nullable(),
